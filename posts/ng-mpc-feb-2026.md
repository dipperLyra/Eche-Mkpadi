---
layout: default
title: "The CBN Just Cut Interest Rates — Here's What It Means"
description: "A brief explainer on the 304th MPC meeting decisions and what the rate cut means for you."
image: /resources/mpc_022026.png
---
...
**The CRR remains unchanged at 45%.** This is the real constraint on lending. Banks still have to park nearly half of all deposits with the CBN. A bank with 100 Naira in deposit must lock 45 Naira with the CBN, that is liquidity not in circulation. Until this number comes down significantly, credit will remain tight regardless of where the MPR sits. If you read the [CP article](ng-commercial-papers), the CRR is one of the reasons companies are going directly to investors instead of banks.
